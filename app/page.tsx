      ...
      <section className="relative min-h-screen flex items-start justify-center overflow-hidden pt-16 md:pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-4">
          ...
          >
            ...
            >
              <div className="relative w-[700px] h-44 md:w-[1000px] md:h-60 lg:w-[1200px] lg:h-72">
                <Image
            ...
            {stores.map((store, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="bg-green-500 text-white px-6 py-3 rounded-lg font-semibold text-center flex items-center justify-center space-x-2">
                    <Phone size={18} />
